...
if (isset($_POST["submit"])) {
    ...
    // Add validation for contact_studid length
    if(strlen($contact_studid) > 20) {
        echo "Failed: Contact Student ID exceeds maximum length.";
        exit();
    }

    $sql = "INSERT INTO `contact`(`contact_id`, `contact_name`, `contact_studid`, `contact_phone`, `contact_email`, `contact_desc`) 
            VALUES (NULL,'$contact_name','$contact_studid','$contact_phone', '$contact_email','$contact_desc')";
